...
/*              related to them. Valid through FY2016 (09/30/16). */
/******************************************************************/
...
/* data IN1.pat_elix_03162018_post201510 ;
   set IN1.pat_elix_03162018 (drop=icd9);
   rename icd10 =DX1;
...
data IN1.pat_elix_03162018_post201510 ;
   set IN1.pat_elix_03162018_post201510 (drop=DRG);
   rename DRG_new = DRG;
run;

data IN1.pat_elix_03162018_post201510 ;
  length DX1 $7. DRG 3.;
  set IN1.pat_elix_03162018_post201510;
run;*/
...
/*******************************************************************/
* Maximum number of DXs;        %LET NUMDX = 1;
* Input SAS file member name;   %LET CORE  = pat_elix_03162018_post201510;

proc contents data = IN1.&CORE;
  proc print data = IN1.&CORE (obs=10);
  run;

DATA OUT1.ANALYSIS;

    SET  IN1.&CORE (KEEP=DRG DX1-DX&NUMDX patid);
