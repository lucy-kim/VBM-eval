...
This analysis code marks Sep 2014 as the first month of the post-intervention period. 
...
load("~/Box Sync/VBM/Data/vbmR/sample-full2017.RData")
...
# change race category labels using the xwalk 
...
lastpremonthidx <- 36 # 36 for Aug 2014
...
save as project
```{r}
save(pat, pat2, pat3, patUse, patUse2, dateLookUp, file="~/Box Sync/VBM/Data/vbmR/sample-full2017.RData")
